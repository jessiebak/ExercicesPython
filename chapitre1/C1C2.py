...
key = input("Entrez la phrase suivante pour NE PAS entrer sur le site : Les chatons sont trop mignons pour moi \n")

if key == "Les chatons sont trop mignons pour moi":
    print("Accès refusé, vous êtes un adulte")
else: 
    print("Accès autorisé: vous êtes un enfant")